...
const make_current = (solsido: Sol_Key, opts: ExerciseOptions) => {
...
const make_exercises = (solsido: Sol_Key) => {
...
const make_you = (solsido: Sol_Key) => {
...
const make_playback = (solsido: Sol_Key) => {
